...
async function runSmoke() {
  ...
  const stateForSummary: AssessmentState = {
    ...
    version: 3,
    evidenceCollections: [
      { findings: [{ id: 'f1', type: 't', severity: 'info', title: 't', description: 'd', target: 't', evidence: 'e', confidence: 1, verificationState: 'observed_anomaly', metadata: { kind: 'discovery_finding_metadata' } }], metadata: {} }
    ],
